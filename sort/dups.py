...
def find_and_move_duplicates(directory):
    """ Function to find duplicate images and move them to a subdirectory """
    hashes = {}
    ...
    for dirpath, _, filenames in os.walk(directory):
        for filename in filenames:
            if filename.lower().endswith(('.png', '.jpg', '.jpeg', '.gif', '.bmp', ".psd")):
...
# Replace '/path/to/your/folder' with the path to the directory you want to scan
find_and_move_duplicates('/Volumes/LaCie/image/artdesign')
